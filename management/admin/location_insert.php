...
<div class="container">
    ...
    <form action="location_insertmain.php" class='mt-3' method="post">
  <div class="mb-3">
    <label for="student_name" class="form-label">Location Name</label>
    <input type="text" class="form-control"  name="location_name" id="" aria-describedby="emailHelp">
  </div>

 
  <div class="mb-3">
  <input type="submit"name="submit"  class='bg-secondary border-0 rounded-3 p-1 px-3'  value="submit">
