    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="student_main_Login.php" class="btn btn-primary rounded-pill px-3 d-none d-lg-block">Student Login<i class="fa fa-arrow-right ms-3"></i></a>&nbsp;&nbsp;
                <a href="Registationpage.php" class="btn btn-primary rounded-pill px-3 d-none 
                d-lg-block">Register Now<i class="fa fa-arrow-right ms-3"></i></a> &nbsp;&nbsp;&nbsp;
...
<form action="locationmain.php" method="post">
    ...
    /* $servername = "localhost";
     ...
     echo "<select class='form-control' style='-webkit-appearance:menulist;' name='loc' required >";
     echo "<option class='form-control' value=''>Select Hostel</option>" ;
