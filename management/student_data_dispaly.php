     ...
     $sql="SELECT *  FROM student s inner join hostel h on s.hostel_id=h.hostel_id inner join payment p on p.student_id=s.student_id where h.hostelowner_id like '".$id."' "; 
      $result = $conn->query($sql);
        ...
        ?>                  
                    ...
                    <td>
                    <a class="btn btn-info" href="studentUpdate.php?student_id=<?php echo $row['student_id']; ?>"style="width:60%;">Edit</a>
...
<h1 style="display:inline;"><u>Student Detail's</u></h1>
    <label for="dte" style="margin-left:53%;"><h3>Select Choice's:</h3></label>
